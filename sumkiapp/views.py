...
def collection(request, coll_name):
    collections = ProductCategory.objects.values_list('product_category', flat = True)
    if coll_name in collections:
        content = Product.objects.filter(category__product_category__contains=coll_name).distinct()
